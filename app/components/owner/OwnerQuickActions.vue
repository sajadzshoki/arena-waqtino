 ...
 *
 * «سرویس‌ها» (فاز ۹)، «پرسنل» (فاز ۱۰) و «ساعات کاری» (فاز ۱۱) این‌جا هستند — هر
 * سه چرخهٔ کامل دارند؛ «مدیریت نوبت‌ها» هنوز در صفحهٔ مدیریت با برچسب صادقانهٔ
 * «به‌زودی» می‌ماند، نه به‌صورت دکمهٔ مرده در داشبورد.
 */
...
const actions = computed<QuickAction[]>(() => [
  ...
  },
  {
    ...
    to: `/owner/business/${props.businessId}/availability`
  },
  {
    key: 'customer-view',
    label: 'دید مشتری',
