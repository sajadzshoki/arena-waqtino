 ...
 *   09222222222 → مشتری + صاحب یک کسب‌وکار (باشگاه انرژی)
 *   09333333333 → مشتری + کارمند (کلینیک پارس)
 *   09123456789 → هر سه قابلیت (پیش‌فرض) + صاحب دو کسب‌وکار (نارنج و آینه)
...
export const DEV_USERS: Record<string, AppUser> = {
  ...
  [DEV_PHONE_ALL]: {
    ...
    capabilities: [
      { kind: 'customer' },
      // دو کسب‌وکار: «نارنج» (فعال، پرنوبت) و «آینه» (تازه، در انتظار بررسی)
      // — سناریوی «صاحب چند کسب‌وکار» که فاز ۸ حول آن ساخته شد
      { kind: 'owner', businessId: 'biz_narenj' },
      { kind: 'owner', businessId: 'biz_ayeneh' },
