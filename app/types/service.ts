...
export interface BookableService {
  ...
  /**
   * چه کسانی این سرویس را انجام می‌دهند. از فاز ۱۰ این فهرست *مشتق‌شده* است:
   * منبع رابطه، `Employee.serviceIds` است و لایهٔ سرویس (`listServices`)
   * نمایِ پرسنل فعال را می‌سازد. پس هیچ‌وقت دستی نوشتنش نمی‌شود.
   */
